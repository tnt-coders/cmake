...
function(tnt_git_DefineProjectVersion)
    ...
    set(${PROJECT_NAME}_VERSION_MAJOR ${versionMajor} PARENT_SCOPE)
    set(${PROJECT_NAME}_VERSION_MINOR ${versionMinor} PARENT_SCOPE)
    set(${PROJECT_NAME}_VERSION_PATCH ${versionPatch} PARENT_SCOPE)
    set(${PROJECT_NAME}_VERSION_TWEAK ${versionTweak} PARENT_SCOPE)
    set(${PROJECT_NAME}_VERSION_IS_DIRTY ${versionIsDirty} PARENT_SCOPE)
    set(${PROJECT_NAME}_VERSION_GIT_HASH ${versionGitHash} PARENT_SCOPE)
endfunction()