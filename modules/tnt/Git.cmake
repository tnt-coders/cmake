...
function(tnt_git_DefineProjectVersion)
    ...
    set_property(DIRECTORY ${PROJECT_SOURCE_DIR}  ${PROJECT_NAME}_VERSION_MAJOR ${versionMajor})
    set_property(DIRECTORY ${PROJECT_SOURCE_DIR}  ${PROJECT_NAME}_VERSION_MINOR ${versionMinor})
    set_property(DIRECTORY ${PROJECT_SOURCE_DIR}  ${PROJECT_NAME}_VERSION_PATCH ${versionPatch})
    set_property(DIRECTORY ${PROJECT_SOURCE_DIR}  ${PROJECT_NAME}_VERSION_TWEAK ${versionTweak})
    set_property(DIRECTORY ${PROJECT_SOURCE_DIR}  ${PROJECT_NAME}_VERSION_IS_DIRTY ${versionIsDirty})
    set_property(DIRECTORY ${PROJECT_SOURCE_DIR}  ${PROJECT_NAME}_VERSION_GIT_HASH ${versionGitHash})
endfunction()