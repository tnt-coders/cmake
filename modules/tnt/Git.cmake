...
function(tnt_git_DefineProjectVersion)
    ...
    set(${PROJECT_NAME}_VERSION_MAJOR ${versionMajor} CACHE INTERNAL)
    set(${PROJECT_NAME}_VERSION_MINOR ${versionMinor} CACHE INTERNAL)
    set(${PROJECT_NAME}_VERSION_PATCH ${versionPatch} CACHE INTERNAL)
    set(${PROJECT_NAME}_VERSION_TWEAK ${versionTweak} CACHE INTERNAL)
    set(${PROJECT_NAME}_VERSION_IS_DIRTY ${versionIsDirty} CACHE INTERNAL)
    set(${PROJECT_NAME}_VERSION_GIT_HASH ${versionGitHash} CACHE INTERNAL)
endfunction()